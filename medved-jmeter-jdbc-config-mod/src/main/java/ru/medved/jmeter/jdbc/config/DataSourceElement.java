...
import ru.medved.json.ConfigReader;
import ru.medved.json.JDBCConfig;
...
public class DataSourceElement extends AbstractTestElement
    ...
    private transient String dataSource, checkQuery, poolMax, connectionAge, timeout,
            trimInterval, section;
    ...
    */
    private ResourceLimitingJdbcDataSource initPool(String maxPool) {
    	log.info("read JDBC properties from : " + this.getConfigFile());
    	
    	ConfigReader reader = new ConfigReader();
    	JDBCConfig cfg = reader.readConfig(this.getConfigFile(),this.getSection());
    	
    	log.info("====[JDBC]====================");
    	log.info("| Section  : "+cfg.getSection());
    	log.info("| URL      : "+cfg.getUrl());
    	log.info("| Driver   : "+cfg.getDriver());
    	log.info("| User     : "+cfg.getUser());
